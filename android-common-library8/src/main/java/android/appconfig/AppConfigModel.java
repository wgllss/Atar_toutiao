...
public class AppConfigModel {
    ...
    public boolean putLong(final String entry, long value, boolean commit) {
        if (mSettingsEditor == null) {
            return false;
        }
        mSettingsEditor.putLong(entry.toString(), value);
        if (commit) {
            return mSettingsEditor.commit();
        }
        return true;
    ...
    public boolean putLong(final String entry, long value) {
        return putLong(entry, value, false);
    }
    ...
    public long getLong(final String entry, long defaultValue) {
        ...
        try {
            return mSettings.getLong(entry.toString(), defaultValue);
        } catch (Exception e) {
            e.printStackTrace();
            return defaultValue;
        }
