package com.atar.toutiao.net.retrofitutils;

import android.graphics.Bitmap;
import android.util.Log;

import com.atar.toutiao.modles.Response;
...
public class RetrofitUtil {
    ...
    /**
     * 自定义异常，当接口返回的{@link Response#code}不为{@link Constant#OK}时，�?��跑出此异�?
     * eg：登陆时验证码错误；参数为传递等
     */
     ...
     * 换言之就是：可以通过它将�?��类型的Observable转换成另�?��类型的Observable�?
     * 和调用一系列的内联操作符是一模一样的�?
     *
     * @param <T>
     * @return
